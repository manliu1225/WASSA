...
from . import load_instances, PureTransformer, ListCountVectorizer, BasicTokenizer, NGramTransformer, CharNGramTransformer, CMUArkTweetPOSTagger, CMUArkTweetBrownClusters, LowercaseTransformer, Negater
...
### start the sentiment features transformer
...
### end the sentiment features transformer
...
preprocessor = make_pipeline(
  ...
  make_union(
    ...
    make_pipeline(CharNGramTransformer([1, 2, 3]), ListCountVectorizer(lowercase=True, max_features=10000, binary=True)),
      # Character n-grams, the difference with BLSTM
