...
import pickle
from .lstm2_senti import BiLSTMSentiFeatureClassifier
...
parser.add_argument('--estimator', required=True, choices=['gbdt', 'lstmclf', 'conclf', 'testclf'], help='give the estimator you want to use.')
...
testclf = BiLSTMSentiFeatureClassifier()
...
# 	elif args.estimator == 'testclf': estimator = testclf
# 	else: estimator = gbdt
