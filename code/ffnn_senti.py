...
from .ffNN import ffNNclassifier
...
class ffNNSentimentclassifier(BaseSentimentClassifier):

  def __init__(self, **kwargs):
    super(ffNNSentimentclassifier, self).__init__(classifier=ffNNclassifier(), **kwargs)
